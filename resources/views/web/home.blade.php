      ...
      <div class="md:w-3/4 mx-auto">
        ...
        <div class="grid gap-6 text-center p-6 md:grid-cols-3 lg:gap-12">
          <div class="mb-12 md:mb-0">
            ...
            <h5 class="mb-4 text-xl font-semibold">Vanesha Siahaan</h5>
            ...
            <p class="mb-4 text-neutral-500">
              ...
              I had the most amazing experience at Del field! The staff were so friendly and welcoming, and my body looked absolutely stunning. I received so many compliments after my appointment and I can't wait to go back!
            </p>
          ...
          <div class="mb-12 md:mb-0">
            ...
            <h5 class="mb-4 text-xl font-semibold">Joy Sihombing</h5>
            <h6 class="mb-4 font-semibold text-primary dark:text-primary-400">
              Graphic Designer
            </h6>
            <p class="mb-4 text-neutral-500">
              ...
              "I had the best experince of my life at Del badminton field! The tariner listened to exactly what I wanted and then gave me a training that exceeded my expectations. I felt so pampered and taken care of throughout the whole process. I can't wait to come back for my next appointment!
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
          ...
          <div class="mb-0">
            ...
            <h5 class="mb-4 text-xl font-semibold">Widya Simanjuntak</h5>
            <h6 class="mb-4 font-semibold text-primary dark:text-primary-400">
            ...
            <p class="mb-4 text-neutral-500">
              ...
              "I had a last-minute body emergency and Del field saved the day! The staff were able to fit me in right away and they did an amazing job. I can't thank them enough for their professionalism and expertise. I will definitely be coming back!"
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
  ...
  <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
    ...
    <div>
      <h6
        ...
        <img class="w-10 h-10" src="{{ asset('images/del.png')}}" alt="">
        Del Badminton Field
    </h6>
      <p class="mb-4 flex items-center justify-center md:justify-start">
        ...
        Sitoluama, Laguboti, Toba, North Sumatera
      </p>
      <p class="mb-4 flex items-center justify-center md:justify-start">
        <svg
          xmlns="http://www.w3.org/2000/svg"
